...
namespace AutoMapperDropDown.Controllers
{
    public class NationalitiesController : Controller
    {
        private readonly UserEmpNationalityContext _context;

        public NationalitiesController(UserEmpNationalityContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'UserEmpNationalityContext.Nationalities'  is null.");
            }
            var nationality = await _context.Nationalities.FindAsync(id);
            if (nationality != null)
            {
